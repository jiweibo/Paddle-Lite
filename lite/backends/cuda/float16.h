...
template <>
struct is_pod<paddle::lite::cuda::float16> {
  static const bool value =
      is_trivial<paddle::lite::cuda::float16>::value &&
      is_standard_layout<paddle::lite::cuda::float16>::value;
};

template <>
struct is_floating_point<paddle::lite::cuda::float16>
    : std::integral_constant<
          bool,
          std::is_same<paddle::lite::cuda::float16,
                       typename std::remove_cv<
                           paddle::lite::cuda::float16>::type>::value> {};

template <>
struct is_signed<paddle::lite::cuda::float16> {
  static const bool value = true;
};

template <>
struct is_unsigned<paddle::lite::cuda::float16> {
  static const bool value = false;
};

inline bool isnan(const paddle::lite::cuda::float16& a) {
  return paddle::lite::cuda::isnan(a);
}

inline bool isinf(const paddle::lite::cuda::float16& a) {
  return paddle::lite::cuda::isinf(a);
}

template <>
struct numeric_limits<paddle::lite::cuda::float16> {
  ...
  static paddle::lite::cuda::float16(min)() {
    return paddle::lite::cuda::raw_uint16_to_float16(0x400);
  }
  static paddle::lite::cuda::float16 lowest() {
    return paddle::lite::cuda::raw_uint16_to_float16(0xfbff);
  }
  static paddle::lite::cuda::float16(max)() {
    return paddle::lite::cuda::raw_uint16_to_float16(0x7bff);
  }
  static paddle::lite::cuda::float16 epsilon() {
    return paddle::lite::cuda::raw_uint16_to_float16(0x0800);
  }
  static paddle::lite::cuda::float16 round_error() {
    return paddle::lite::cuda::float16(0.5);
  }
  static paddle::lite::cuda::float16 infinity() {
    return paddle::lite::cuda::raw_uint16_to_float16(0x7c00);
  }
  static paddle::lite::cuda::float16 quiet_NaN() {
    return paddle::lite::cuda::raw_uint16_to_float16(0x7e00);
  }
  static paddle::lite::cuda::float16 signaling_NaN() {
    return paddle::lite::cuda::raw_uint16_to_float16(0x7e00);
  }
  static paddle::lite::cuda::float16 denorm_min() {
    return paddle::lite::cuda::raw_uint16_to_float16(0x1);
  }
};
